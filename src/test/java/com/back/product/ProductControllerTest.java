...
import com.back.product.controller.ProductController;
...
class ProductControllerTest {
        ...
        void t1() throws Exception {
                var request = new ProductController.CreateRequest("Gaming Laptop",
                                List.of("laptop", "gaming", "high-performance"));
        ...
        void t13() throws Exception {
                ...
                var request = new ProductController.ChatRequest(
                                "I need a laptop for gaming. Can you recommend something?");
        ...
        void t14() throws Exception {
                ...
                var request = new ProductController.ChatRequest(
                                "Find products similar to product ID " + laptop.getId());
