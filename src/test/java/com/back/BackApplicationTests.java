...
class BackApplicationTests {
    ...
    void t7() {
        ...
        List<Product> results = productService.knnSearch(List.of("gaiming", "computer"), 3);
    ...
    void t8() {
        ...
        List<Product> results = productService.knnSearch(List.of("coffee", "caffeine", "beverage"), 3);
    ...
    @Test
    @DisplayName("ProductService - KNN Search findSimilarProducts test")
    void t9() {
        // given
